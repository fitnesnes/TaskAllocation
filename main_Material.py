...
parser.add_argument('--model_dir',default="./models/Material")
...
if not args.evaluate:
    ...
    for epoch in range(args.max_epoch):
        ...
        while not done:  
            ...
            time+=1
            action = take_action_material(allocation,info)
